    ...
    <div className="relative w-full flex items-center justify-center mt-8">
      <div className="flex flex-col gap-6 items-center text-white absolute z-2">
        <div className="flex flex-col gap-3 items-center">
          <h1 className="font-semibold text-xl text-center sm:text-3xl md:text-4xl lg:text-5xl">
            Import your{" "}
          ...
          <p className="text-xs text-stone-100 text-center sm:text-sm md:text-base lg:text-lg">
            Use{" "}
            <span className="font-bold underline underline-offset-4 text-orange-300">
              JSON
            </span>{" "}
        ...
        <Link
          className="bg-orange-400 text-sm mb-2 px-2 py-1 transition-colors ease-in-out font-bold flex items-center gap-2 rounded-md hover:cursor-pointer text-orange-800 hover:bg-orange-500 sm:px-4 sm:py-2 sm:text-base lg:px-6 lg:py-2 lg:text-xl"
          to="/upload-file"
        >
          <FaFileImport />
          Import
